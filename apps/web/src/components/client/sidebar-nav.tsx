...
import type { SidebarNavItem } from '@/lib/newyolk/types/nav'
...
export interface ClientSidebarNavProps {
...
interface ClientSidebarNavItemsProps {
  items: SidebarNavItem[]
  locale: LocaleOptions
...
export function ClientSidebarNavItems({
  items,
  pathname,
  locale,
  isMobile,
  handleMobileSidebar,
}: ClientSidebarNavItemsProps) {
